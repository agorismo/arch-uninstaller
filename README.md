...
this is a cosmetic warning from `polkit-gnome` indicating that no user avatar image was found. It does not affect functionality. You can suppress it by creating a dummy file:
